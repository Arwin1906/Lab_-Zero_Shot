...
class TimeSeriesDataset(Dataset):
    def __init__(self,train_set_branch_y_collection=None,
                train_set_branch_t_collection=None,
                train_set_trunk_collection=None, 
                branch_mask_collection=None,
                test_truth_collection=None,
        ...
        self.samples_collection  = samples
    ...
    def __getitem__(self, idx):
        ...
        stats = torch.tensor(self.stats_collection[idx], dtype=torch.float32)
        norm_props = torch.tensor(self.norm_props[idx], dtype=torch.float32)

        samples = torch.tensor(self.samples_collection [idx], dtype=torch.float32)
