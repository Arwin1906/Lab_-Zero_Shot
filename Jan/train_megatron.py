...
(train_set_branch_y, train_set_branch_t, train_set_trunk_t,
 branch_mask, test_truth,stats,norm_param,samples,samples_noisy) =  load_data(postfix="train_minmax")
n = 20000
...
lr_scheduler = InverseSquareRootLR(optim,warmup_steps=0,init_lr=1e-5,min_lr=1e-5)
